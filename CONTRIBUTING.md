# Contributing to IETF Drafts

If you're new to the [IETF](https://www.ietf.org/), you may also want to read [Getting Started the IETF](https://www.ietf.org/participate/get-started/) and [an informal guide to the IETF process](https://www.ietf.org/process/informal/).
